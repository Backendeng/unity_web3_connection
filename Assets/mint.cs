...
public class mint : MonoBehaviour
{
    ...
    private string DexCoin_contract = "0x576b7e1bD9A9E70780349219f9359468Eb2fF0a1";
    private string DexNFT_contract = "0x3493Ee07006c73c55f07Ef47c6e3A05BD7B3a0D3";
    ...
    int Leader_items_cost = 3000;
    int Legendary_items_cost = 200;
    int Epic_items_cost = 150;
    int Rare_items_cost = 100;
    int Uncommon_items_cost = 75;
    int Common_items_cost = 50;

    
    async public void minting() {
        Approve();
        Mint();
    }
    ...
    async public void Approve() {
       ...
       // function name
        ...
        amount = cost.ToString()+"000000000000000000";
        Debug.Log(amount);
